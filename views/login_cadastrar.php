...
<head>
    ...
    <title>FriendBook - Cadastrar</title>
</head>
<body id="body-forms">
    ...
    <div class="container" id="container-login-cadastrar">
        <h1>Cadastrar</h1>
        ...
        <form method="POST">
            <div class="form-group">
                ...
                <input type="email" name="email" id="email" placeholder="Cadastre um email..." required>
            </div>
